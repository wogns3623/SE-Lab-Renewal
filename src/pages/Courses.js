...
class Courses extends Component {
  ...
  state = {
    courseHome: [
      {
        explain: 'In this course, the followings will be covered to adequately enable web programming and web application development:',
        list: [
  ...
  render() {
    return (
      <PageTemplate className='Courses'>
        ...
        <CourseBox title="Course Objectives" courseHome={this.state.courseHome.slice(0, 1)}>
        </CourseBox>
        <CourseBox2 title="Lecturer: Scott Lee" courseHome={this.state.courseHome.slice(1, 2)}>
        </CourseBox2>
        <CourseBox3 title="Teaching Assistants" courseHome={this.state.courseHome.slice(2, 4)}>
        </CourseBox3>
        <CourseBox4 title="Places_Dates" courseHome={this.state.courseHome.slice(4, 6)}>
        </CourseBox4>
        <CourseBox2 title="Course Forum" courseHome={this.state.courseHome.slice(6,7)}>
        </CourseBox2>
        <CourseBox2 title="Textbooks" courseHome={this.state.courseHome.slice(7,8)}>
        </CourseBox2>
        <CourseBox2 title="Course Schedule" courseHome={this.state.courseHome.slice(8,9)}>
        </CourseBox2>
